...
const cases: CategoryCase[] = [
  ...
  { text: 'JCB 3530111333300000', category: 'credit_card', shouldDetect: true, description: 'jcb valid' },
  ...
  { text: 'AB1234567', category: 'passport', shouldDetect: false, description: 'passport without context' },
  ...
  { text: 'my id is 1101700203450', category: 'national_id', shouldDetect: false, description: 'generic id keyword only' },
  ...
  { text: 'individual number 9999999999994', category: 'national_id', shouldDetect: false, description: '13 digits without context' },
